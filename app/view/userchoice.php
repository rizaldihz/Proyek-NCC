...
<body>
	<div class="hero-image-choice">
	    ...
	    <a href="<?php echo $dir ?>/reserve"><button class="butres" style=" font-size: 15pt;">reserve now</button></a>
	    <a href="<?php echo $dir ?>/upload"><button class="butres" style="width: 20%; font-size: 15pt;">upload reservation file</button></a>
